...
const reporteCorto = {
  ...
  reporteCortoCitiBanco: async (req, res) => {
    const datos = [
      { opcion: 1, nombre: "CNC", ventas: 4 },
      { opcion: 2, nombre: "CPC", ventas: 5 },
      { opcion: 3, nombre: 'CLI' } 
    ];
    ...
    // datos.forEach((item, index) => {
        const campaign = 1013;
        const nameProcedure = "sps_reporte_corto_2";
        let parameters = { v_opcion: element.opcion, v_producto: 1 };
        ...
        if (objConnOracle == null || objConnOracle == undefined) {
          ...
          try {
            ...
            if (oraRspta == 0) { // CREAR CNC
              ...
              if (element.opcion == 3) { // CLI
                // const workbook = new ExcelJS.Workbook();
                const worksheet = workbook.addWorksheet('Reporte_Corto_' + element.nombre);
                
                const ws_data = [
                  [fecha_actual, '11:00', '14:00', '16:00', '19:00', 'TOTAL'],
                  ['WS Bau', '-', '-', '-', '-', '-'],
                  ['WS G1', '', '', '', '', ''],
                  ['WS G2', '', '', '', '', ''],
                  ['WS G3', '', '', '', '', ''],
                ...
                // aplicarEstilos(ws_data, worksheet, workbook, res, item.opcion);
                ...
                worksheet.getCell('A1').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: '002672' } };
                worksheet.getCell('B1').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('B1').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: '002672' } };
                worksheet.getCell('C1').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('C1').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: '002672' } };
                worksheet.getCell('D1').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('D1').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: '002672' } };
                worksheet.getCell('E1').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('E1').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: '002672' } };
                worksheet.getCell('F1').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('F1').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: '002672' } };

                worksheet.getCell('A2').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('A2').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: '618fea' } };

                worksheet.getCell('B2').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('B2').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: '9edce7' } };
                worksheet.getCell('C2').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('C2').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: '9edce7' } };
                worksheet.getCell('D2').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('D2').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: '9edce7' } };
                worksheet.getCell('E2').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('E2').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: '9edce7' } };
                worksheet.getCell('F2').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('F2').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: '9edce7' } };

                worksheet.getCell('A8').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('A8').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: '549456' } };
                worksheet.getCell('B8').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('B8').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'c5d9c6' } };
                worksheet.getCell('C8').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('C8').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'c5d9c6' } };
                worksheet.getCell('D8').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('D8').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'c5d9c6' } };
                worksheet.getCell('E8').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('E8').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'c5d9c6' } };
                worksheet.getCell('F8').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('F8').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'c5d9c6' } };

                worksheet.getCell('A14').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('A14').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: '618fea' } };
                worksheet.getCell('B14').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('B14').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: '99bfea' } };
                worksheet.getCell('C14').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('C14').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: '99bfea' } };
                worksheet.getCell('D14').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('D14').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: '99bfea' } };
                worksheet.getCell('E14').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('E14').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: '99bfea' } };
                worksheet.getCell('F14').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('F14').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: '99bfea' } };

                worksheet.getCell('A15').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('A15').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: '549456' } };
                worksheet.getCell('B15').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('B15').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'c5d9c6' } };
                worksheet.getCell('C15').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('C15').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'c5d9c6' } };
                worksheet.getCell('D15').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('D15').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'c5d9c6' } };
                worksheet.getCell('E15').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('E15').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'c5d9c6' } };
                worksheet.getCell('F15').font = { name: 'Calibri', size: 12, bold: true, color: { argb: 'ffffff' } };
                worksheet.getCell('F15').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'c5d9c6' } };
                
                // Especificar la ruta del archivo
                const outputPath = path.join(__dirname, "..", 'assets/docs', 'Reporte_Corto.xlsx');
                ...
                // const workbook = new ExcelJS.Workbook();
                const worksheet = workbook.addWorksheet('Reporte_Corto_' + element.nombre);
                // const worksheet = workbook.addWorksheet('Reporte_Corto_'+item.nombre);

                const ws_data = [
                    [fecha_actual, "CORTE", "", element.nombre, ""],
                ...
                const filePath = path.join(__dirname, "..", "assets/docs", "Reporte_Corto.xlsx");
                try {
                // // Escribir el archivo
                    workbook.xlsx.writeFile(outputPath);
                    console.log(`Archivo Excel guardado en: ${outputPath}`);
              ...
              if (element.opcion == 3) {
                ...
                if (oraRspta.length > 1) {
                    ...
                    total_sw_g1 = p1_9_11_g1 + p1_11_14_g1;
                    total_ventas_g2 = p2_9_11_g2 + p2_11_14_g2;
                    total_sw_g2 = p1_9_11_g2 + p1_11_14_g2;
                    total_ventas_g3 = p2_9_11_g3 + p2_11_14_g3;
                    total_sw_g3 = p1_9_11_g3 + p1_11_14_g3;
                    total_ventas_g4 = p2_9_11_g4 + p2_11_14_g4;
                    total_sw_g4 = p1_9_11_g4 + p1_11_14_g4;
                    total_ventas_g5 = p2_9_11_g5 + p2_11_14_g5;
                    total_sw_g5 = p1_9_11_g5 + p1_11_14_g5;
                ...
                if (oraRspta.length > 2) {
                    ...
                    total_sw_g1 = p1_9_11_g1 + p1_11_14_g1 + p1_14_16_g1;
                    total_ventas_g2 = p2_9_11_g2 + p2_11_14_g2 + p2_14_16_g2;
                    total_sw_g2 = p1_9_11_g2 + p1_11_14_g2 + p1_14_16_g2;
                    total_ventas_g3 = p2_9_11_g3 + p2_11_14_g3 + p2_14_16_g3;
                    total_sw_g3 = p1_9_11_g3 + p1_11_14_g3 + p1_14_16_g3;
                    total_ventas_g4 = p2_9_11_g4 + p2_11_14_g4 + p2_14_16_g4;
                    total_sw_g4 = p1_9_11_g4 + p1_11_14_g4 + p1_14_16_g4;
                    total_ventas_g5 = p2_9_11_g5 + p2_11_14_g5 + p2_14_16_g5;
                    total_sw_g5 = p1_9_11_g5 + p1_11_14_g5 + p1_14_16_g5;
                ...
                if (oraRspta.length > 3) {
                    ...
                    total_sw_g1 = p1_9_11_g1 + p1_11_14_g1 + p1_14_16_g1 + p1_16_19_g1;
                    total_ventas_g2 = p2_9_11_g2 + p2_11_14_g2 + p2_14_16_g2 + p2_16_19_g2;
                    total_sw_g2 = p1_9_11_g2 + p1_11_14_g2 + p1_14_16_g2 + p1_16_19_g2;
                    total_ventas_g3 = p2_9_11_g3 + p2_11_14_g3 + p2_14_16_g3 + p2_16_19_g3;
                    total_sw_g3 = p1_9_11_g3 + p1_11_14_g3 + p1_14_16_g3 + p1_16_19_g3;
                    total_ventas_g4 = p2_9_11_g4 + p2_11_14_g4 + p2_14_16_g4 + p2_16_19_g4;
                    total_sw_g4 = p1_9_11_g4 + p1_11_14_g4 + p1_14_16_g4 + p1_16_19_g4;
                    total_ventas_g5 = p2_9_11_g5 + p2_11_14_g5 + p2_14_16_g5 + p2_16_19_g5;
                    total_sw_g5 = p1_9_11_g5 + p1_11_14_g5 + p1_14_16_g5 + p1_16_19_g5;

                }

                total_v_h11 = p2_9_11_g1 + p2_9_11_g2 + p2_9_11_g3 + p2_9_11_g4 + p2_9_11_g5;
                total_v_h14 = p2_11_14_g1 + p2_11_14_g2 + p2_11_14_g3 + p2_11_14_g4 + p2_11_14_g5;
                total_v_h16 = p2_14_16_g1 + p2_14_16_g2 + p2_14_16_g3 + p2_14_16_g4 + p2_14_16_g5;
                total_v_h19 = p2_16_19_g1 + p2_16_19_g2 + p2_16_19_g3 + p2_16_19_g4 + p2_16_19_g5;
                total_ventas_gral = total_ventas_g1 + total_ventas_g2 + total_ventas_g3 + total_ventas_g4 + total_ventas_g5;
                ...
                const ws_data = [
                  [oraRspta[0]["FECHA"], '11:00', '14:00', '16:00', '19:00', 'TOTAL'],
                  ['WS Bau', '-', '-', '-', '-', '-'],
                  ['WS G1', p1_9_11_g1, p1_11_14_g1, p1_14_16_g1, p1_16_19_g1, total_sw_g1],
                  ['WS G2', p1_9_11_g2, p1_11_14_g2, p1_14_16_g2, p1_16_19_g2, total_sw_g2],
                  ['WS G3', p1_9_11_g3, p1_11_14_g3, p1_14_16_g3, p1_16_19_g3, total_sw_g3],
                  ['WS G4', p1_9_11_g4, p1_11_14_g4, p1_14_16_g4, p1_16_19_g4, total_sw_g4],
                  ['WS G5', p1_9_11_g5, p1_11_14_g5, p1_14_16_g5, p1_16_19_g5, total_sw_g5],
                  ['Ventas Bau', '-', '-', '-', '-', '-'],
                  ['VENTAS G1', p2_9_11_g1, p2_11_14_g1, p2_14_16_g1, p2_16_19_g1, total_ventas_g1],
                  ['VENTAS G2', p2_9_11_g2, p2_11_14_g2, p2_14_16_g2, p2_16_19_g2, total_ventas_g2],
                  ['VENTAS G3', p2_9_11_g3, p2_11_14_g3, p2_14_16_g3, p2_16_19_g3, total_ventas_g3],
                  ['VENTAS G4', p2_9_11_g4, p2_11_14_g4, p2_14_16_g4, p2_16_19_g4, total_ventas_g4],
                  ['VENTAS G5', p2_9_11_g5, p2_11_14_g5, p2_14_16_g5, p2_16_19_g5, total_ventas_g5],
                  ['General', total_v_h11, total_v_h14, total_v_h16, total_v_h19, total_ventas_gral],
                  ['Ventas General', '-', '-', '-', '-', '-']
                ];
                // aplicarEstilos(ws_data, worksheet, workbook, res, item.opcion);
                // Añadir los datos a la hoja de trabajo
                ...
                // parameters = { producto: element.ventas, opcion: '1' };
                parameters = { v_opcion: element.ventas, v_producto: 1 };
                objConnOracle = await createConnObj(campaign, nameProcedure, parameters);
                // console.log(objConnOracle);
                try {
                ...
                const ws_data = [
                    [oraRspta[0]["FECHA"], "CORTE", "", element.nombre, ""],
                    ["", "", "", "G1", "G2", "G3", "G4", "G5", "Recarga", "Recovery", "Total"],
      ...
      if (index === datos.length - 1) {
          console.log("Este es el último elemento:", element);
          enviarCorreo(res);
      } else {
...
async function enviarCorreo(res) {
  ...
  const mails= await actionsMysql.mailsAsistencia(2);
    if (mails.length == 0) {
      ...
      const mailOptions = {
          to: emailString,                
          subject: 'Reporte Corto CitiBanco',      
          html: 'Reporte Corto CitiBanco CNC,CPC,CLI',
          attachments: [
          {
              filename: 'Reporte_Corto.xlsx',
              path: filePath
          }
          ]
      }
      let nObjMailer = await actMailer.createObjMailer(mailOptions)
      // let nObjMailer = await actMailer.createObjMailerCitiBanco(mailOptions)
