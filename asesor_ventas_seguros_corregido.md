...
- **<{saludo}>**  
- **<{despedida}>**  
- **<{nombreDePila}>**    !!! NO ASIGNAS VARIABLES **<{nombreDePila}>** EJEMPLO DE la variable  {{nombre}} sale <{Nombredepila}> : es el primer nombre de {{nombre}} SI LO COLOCAS ASI EL BOT SE CONFUNDE
- **<{modelo_auto}>**  !!! DEBES DE DARLE UN PCOO MAS DE CONTEXTO DE QUE ES ESA VARIABLE Y COMO VA OBTENER LA VARIABLE
  Ejemplos:  
...
Asignación de saludo y despedida según la hora actual: !!! FALTO LA VARIABLE {{time}} y si usas despedida y saludo aqui debes asiganrlos
...
!!! # MUY Bien igual aqui puedes dar un contexto breve para que el bot sepa cuando calificar y no depender del flujo sino darle una instruccion que califique ACORDE A  ## Calificaciones permitidas 
1. **Buzon de voz**  
2. **No lo conocen**  
3. **Fallecido**  
...
Esperar respuesta para continuar el flujo !!! COMO RECOMENDACION PUEDES OMITIR EL ESPERAR RESPUESTA .... PUES NO HICISTE NINGUNA PREGUNTA LUEGO SE PUEDE INTERPRTAR COMO QUE SE QUED CALLADO EL BOT

“Le llamo porque estamos ofreciendo una tarifa preferencial para asegurar su auto <{modelo_auto}> y quiero verificar si esta oferta podría beneficiarle.”  !!! AQUI VEO QUE USAS  <{modelo_auto}> PEOR NO ASIGNASTE UN VALOR, SI ES UNA VARIABLE QUE CARGAS DESDE EL CW SE USA {{}} QUEDANDO ASI {{modelo_auto}}
...
!!! OMITISTE EL FINALIZA CONVERSACION 

OBSERVACIONES GENERALES:
ME GSUTO MUCHO EL PROMT LO ESTRUTURASTE BIEN HE HICSTE UN MANEJO BUENO DE LAS VARIABLES Y HERRAMIETAS, SI HACES LOS CAMBIOS QUE TE HICE EN CADA PARTE PUEDES PROBARLO, IGUAL PUEDES TOMAR LO APRENDIDO DEL MODULO 4 Y VER COMO OPTIMIZRLO O POSIBLES FALLOS QUE PUDE OMITIR  
